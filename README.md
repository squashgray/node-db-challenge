...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      ANSWER: relational databases are databases that store their data in a tabular format and SQL is the lanaguage used to communicate with them.
- [x] Why do tables need a `primary key`?
      ANSWER: primary keys how you identify each table entry uniquely, it is essential in storing and searching specific pieces of data.
- [x] What is the name given to a table column that references the primary key on another table.
      ANSWER: Foreign Key
- [x] What do we need in order to have a _many to many_ relationship between two tables.
      ANSWER: Make a third table for the foreign keys of the other two tables.
